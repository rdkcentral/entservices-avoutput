...
# Instruction Summary
  1. [Inter-Plugin Communication](https://github.com/rdkcentral/entservices-avoutput/blob/develop/.github/instructions/Pluginimplementation.instructions.md#inter-plugin-communication)
  2. [On-Demand Plugin Interface Acquisition](https://github.com/rdkcentral/entservices-avoutput/blob/develop/.github/instructions/Pluginimplementation.instructions.md#on-demand-plugin-interface-acquisition)
